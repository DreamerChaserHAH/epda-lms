...
<head>
    ...
    <title>Lecturer Dashboard | APU LMS</title>
...
<body class="min-h-screen bg-gray-50">
    ...
    <div class="navbar bg-primary text-white">
        <div class="flex-1">
            <a class="btn btn-ghost normal-case text-xl">APU LMS - Lecturer</a>
        </div>
        <div class="flex-none">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Card 2: Grade Submissions -->
            <div class="card bg-white shadow-xl">
                <div class="card-body">
                    <h2 class="card-title">Grade Submissions</h2>
